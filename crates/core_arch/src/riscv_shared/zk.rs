...
#[inline]
pub fn pack(rs1: usize, rs2: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "pack {rd},{rs1},{rs2}",
...
#[inline]
pub fn packh(rs1: usize, rs2: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "packh {rd},{rs1},{rs2}",
...
#[inline]
pub fn sha256sig0(rs1: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "sha256sig0 {rd},{rs1}",
...
#[inline]
pub fn sha256sig1(rs1: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "sha256sig1 {rd},{rs1}",
...
#[inline]
pub fn sha256sum0(rs1: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "sha256sig1 {rd},{rs1}",
...
#[inline]
pub fn sha256sum1(rs1: usize) -> usize {
    let value: usize;
    unsafe {
        asm!(
            "sha256sig1 {rd},{rs1}",
...
/// # Note
///
/// Only the bottom 2 bits of `bs` are used.
///
/// ## Details
///
...
#[inline]
pub fn sm4ed(rs1: usize, rs2: usize, bs: u8) -> usize {
    macro_rules! sm4ed {
        ($imm2:expr) => {{
            let value: usize;
            unsafe {
...
#[inline]
pub fn sm4ks(rs1: usize, rs2: usize, bs: u8) -> usize {
    macro_rules! sm4ks {
        ($imm2:expr) => {{
            let value: usize;
            unsafe {
